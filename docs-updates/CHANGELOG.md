...
### Updated
- docs/template-import.md → ## Changelog — improvement note added
- docs/nexter-blocks.md → ## Changelog — bug fix note added
- docs/general.md → ## Changelog — bug fix note added
